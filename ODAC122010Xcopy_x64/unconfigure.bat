...
"%BATCH_DIR%"asp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.111.Oracle.Web, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"asp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.112.Oracle.Web, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"asp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.121.Oracle.Web, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log

REM Remove the aspnet provider assembly from the GAC
"%BATCH_DIR%"asp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Oracle.Web, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
...
REM Remove the aspnet provider assembly from the GAC
"%BATCH_DIR%"asp.net\bin\4\OraProvCfg.exe /action:ungac /providerpath:"Oracle.Web, Version=4.122.1.0" >> uninstall.log
...
"%BATCH_DIR%"\odp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.102.Oracle.DataAccess, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"\odp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.111.Oracle.DataAccess, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"\odp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.112.Oracle.DataAccess, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"\odp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Policy.2.121.Oracle.DataAccess, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log

REM remove the odp 2.x assembly in the GAC
"%BATCH_DIR%"\odp.net\bin\2.x\OraProvCfg.exe /action:ungac /providerpath:"Oracle.DataAccess, Version=2.122.1.0,processorArchitecture=AMD64" >> uninstall.log
...
echo [-HKEY_LOCAL_MACHINE\SOFTWARE\Oracle\ODP.NET\2.122.1.0]  >> "%BATCH_DIR%"\odp.net.reg
...
"%BATCH_DIR%"\odp.net\bin\4\OraProvCfg.exe /action:ungac /providerpath:"Policy.4.112.Oracle.DataAccess, Version=4.122.1.0,processorArchitecture=AMD64" >> uninstall.log
"%BATCH_DIR%"\odp.net\bin\4\OraProvCfg.exe /action:ungac /providerpath:"Policy.4.121.Oracle.DataAccess, Version=4.122.1.0,processorArchitecture=AMD64" >> uninstall.log

REM remove the odp 4 assembly in the GAC
"%BATCH_DIR%"\odp.net\bin\4\OraProvCfg.exe /action:ungac /providerpath:"Oracle.DataAccess, Version=4.122.1.0,processorArchitecture=AMD64" >> uninstall.log
...
echo Windows Registry Editor Version 5.00                     >  "%BATCH_DIR%"\odp.net.reg
echo [-HKEY_LOCAL_MACHINE\SOFTWARE\Oracle\ODP.NET\4.122.1.0]  >> "%BATCH_DIR%"\odp.net.reg
...
echo   unconfigure.bat odp.net2  myhome     true  (unconfigure ODP.NET 2, configure at machine level)
